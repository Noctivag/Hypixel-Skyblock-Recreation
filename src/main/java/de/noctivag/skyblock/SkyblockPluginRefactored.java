...
public class SkyblockPluginRefactored extends JavaPlugin {
    ...
    private void initializeLegacySystems() {
        ...
        // TeleportService (nach WorldResetService)
        teleportService = new TeleportService(this, serviceManager);
        serviceManager.registerService(TeleportService.class, teleportService);
        
        // HubSpawnSystem
        if (settingsConfig.isHubSpawnSystemEnabled()) {
            hubSpawnSystem = new HubSpawnSystem(this, rollingRestartWorldManager);
    ...
    private void registerCommands() {
        ...
        commandSystem = new AdvancedCommandSystem(this);
