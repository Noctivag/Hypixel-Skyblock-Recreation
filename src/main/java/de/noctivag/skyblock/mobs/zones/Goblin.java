...
public class Goblin extends ZoneMob {
    ...
    public void useAbility(LivingEntity entity) {
        ...
        loc.getWorld().spawnParticle(Particle.VILLAGER_HAPPY, loc, 30, 2, 2, 2, 0.1);
    ...
    private void stealCoins(Player player) {
        try {
            PlayerProfileService playerProfileService = plugin.getServer().getPluginManager()
                .getPlugin("HypixelSkyblockRecreation").getServiceManager()
    ...
    public void onDeath(LivingEntity entity) {
        ...
        // Death effects
        loc.getWorld().spawnParticle(Particle.VILLAGER_HAPPY, loc, 50, 2, 2, 2, 0.2);
