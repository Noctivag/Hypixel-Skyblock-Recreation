...
/**
 * Pet Storage GUI - Haustier-Lager und -Speicher
 */
public class PetStorageGUI {
    
    private final SkyblockPlugin SkyblockPlugin;
    
    public PetStorageGUI(SkyblockPlugin SkyblockPlugin) {
        this.SkyblockPlugin = SkyblockPlugin;
    }
    
    public void openPetStorageGUI(Player player) {
        Inventory gui = Bukkit.createInventory(null, 54, Component.text("§6§lPet Storage"));
        
        // Storage Types
        setItem(gui, 10, Material.CHEST, "§6§lPet Chests",
            "§7Haustier-Truhen",
            "§7• Basic Chests",
            "§7• Premium Chests",
            "§7• Special Chests",
        ...
        setItem(gui, 11, Material.ENDER_CHEST, "§d§lPet Ender Storage",
        ...
        setItem(gui, 12, Material.SHULKER_BOX, "§b§lPet Shulker Storage",
        ...
        setItem(gui, 13, Material.BARREL, "§6§lPet Barrel Storage",
        ...
        setItem(gui, 14, Material.HOPPER, "§7§lPet Hopper Storage",
