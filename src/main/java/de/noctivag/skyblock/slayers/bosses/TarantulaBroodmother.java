...
/**
 * Tarantula Broodmother - Spider slayer boss
 */
public class TarantulaBroodmother extends SlayerBoss {
    
    public TarantulaBroodmother(Location spawnLocation, int tier) {
        super("TARANTULA_BROODMOTHER", spawnLocation, tier, "TARANTULA");
    ...
    public String getName() {
        return "§cTarantula Broodmother §7[Tier " + getTier() + "]";
    }
    
    @Override
    public String getLootTableId() {
        return "tarantula_broodmother_tier_" + getTier();
    }
