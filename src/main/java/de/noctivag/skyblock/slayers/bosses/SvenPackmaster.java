...
/**
 * Sven Packmaster - Wolf slayer boss
 */
public class SvenPackmaster extends SlayerBoss {
    
    public SvenPackmaster(Location spawnLocation, int tier) {
        super("SVEN_PACKMASTER", spawnLocation, tier, "SVEN");
    ...
    public String getName() {
        return "§cSven Packmaster §7[Tier " + getTier() + "]";
    }
    
    @Override
    public String getLootTableId() {
        return "sven_packmaster_tier_" + getTier();
    }
