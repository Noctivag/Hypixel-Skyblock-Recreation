...
public class SvenPackmaster extends SlayerBoss {
    ...
    private void spawnSvenFollower() {
        ...
        follower.getAttribute(org.bukkit.attribute.Attribute.GENERIC_MAX_HEALTH).setBaseValue(40);
        follower.setHealth(40);
        follower.getAttribute(org.bukkit.attribute.Attribute.GENERIC_ATTACK_DAMAGE).setBaseValue(12);
        follower.getAttribute(org.bukkit.attribute.Attribute.GENERIC_MOVEMENT_SPEED).setBaseValue(0.3);
