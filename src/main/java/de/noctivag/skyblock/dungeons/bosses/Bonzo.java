...
public class Bonzo extends DungeonBoss implements Listener {
    ...
    protected void spawnBoss() {
        ...
        // Set boss attributes
        bonzo.getAttribute(Attribute.GENERIC_MAX_HEALTH).setBaseValue(maxHealth);
        bonzo.setHealth(maxHealth);
        bonzo.getAttribute(Attribute.GENERIC_ATTACK_DAMAGE).setBaseValue(damage);
        bonzo.getAttribute(Attribute.GENERIC_MOVEMENT_SPEED).setBaseValue(0.2);
    ...
    private void spawnMinions() {
        ...
        for (int i = 0; i < minionCount; i++) {
            ...
            minion.getAttribute(Attribute.GENERIC_MAX_HEALTH).setBaseValue(50);
            minion.setHealth(50);
            minion.getAttribute(Attribute.GENERIC_ATTACK_DAMAGE).setBaseValue(10);
        }
