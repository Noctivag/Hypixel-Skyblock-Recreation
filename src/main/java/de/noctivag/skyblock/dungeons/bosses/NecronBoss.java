...
import de.noctivag.skyblock.dungeons.bosses.Terminal;
import de.noctivag.skyblock.dungeons.bosses.TerminalType;
import de.noctivag.skyblock.dungeons.bosses.CrystalPodium;
import de.noctivag.skyblock.dungeons.bosses.CrushingPillar;
...
public class NecronBoss implements Listener {
    ...
    public NecronBoss(de.noctivag.skyblock.SkyblockPlugin SkyblockPlugin) {
    ...
    public void spawnNecron(Location location) {
        ...
        phaseStartTime = java.lang.System.currentTimeMillis();
        isStunned = false;
        lastAbilityTime = java.lang.System.currentTimeMillis();
    ...
    private void initializePhase1Components(Location center) {
        ...
        for (int i = 0; i < 2; i++) {
            ...
            CrystalPodium podium = new CrystalPodium(podiumLoc, CrystalPodium.CrystalType.WIND);
    ...
    private void initializePhase2Components(Location center) {
        ...
        for (int i = 0; i < 4; i++) {
            ...
            CrushingPillar pillar = new CrushingPillar(pillarLoc); // 30 block height
    ...
    private void initializePhase3Components(Location center) {
        ...
        for (int i = 0; i < 8; i++) {
            ...
            Terminal terminal = new Terminal(terminalLoc, de.noctivag.skyblock.dungeons.bosses.TerminalType.COLOR);
    ...
    private void stunNecron() {
        ...
        }.runTaskLater(SkyblockPlugin, 200L); // 10 seconds
    }
