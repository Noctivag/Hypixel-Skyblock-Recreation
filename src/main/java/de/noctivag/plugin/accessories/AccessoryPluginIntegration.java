...
import de.noctivag.plugin.talismans.AdvancedTalismanSystem;
import de.noctivag.plugin.commands.AccessoryCommands;
...
public class AccessoryPluginIntegration {
    ...
    public AccessoryPluginIntegration(Plugin plugin, MultiServerDatabaseManager databaseManager) {
        this.plugin = plugin;
    ...
    private void registerCommands() {
        JavaPlugin javaPlugin = (JavaPlugin) Bukkit.getPluginManager().getPlugin(plugin.getName());
        if (javaPlugin != null) {
