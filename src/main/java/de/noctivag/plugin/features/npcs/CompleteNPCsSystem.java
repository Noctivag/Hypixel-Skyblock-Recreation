package de.noctivag.plugin.features.npcs;
import org.bukkit.inventory.ItemStack;

import de.noctivag.plugin.Plugin;
import de.noctivag.plugin.core.api.System;
import de.noctivag.plugin.core.api.SystemStatus;
import de.noctivag.plugin.features.npcs.types.CompleteNPCType;
import de.noctivag.plugin.features.npcs.types.NPCCategory;
import de.noctivag.plugin.features.npcs.types.NPCRarity;
import de.noctivag.plugin.features.npcs.world.NPCWorldManager;
import de.noctivag.plugin.features.npcs.world.NPCAreaMapping;
...
public class CompleteNPCsSystem implements System {
    ...
    public CompleteNPCsSystem(Plugin plugin) {
        this.plugin = plugin;
