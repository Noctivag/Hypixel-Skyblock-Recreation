package de.noctivag.plugin.features.weapons;
import org.bukkit.inventory.ItemStack;

import de.noctivag.plugin.core.api.Service;
import de.noctivag.plugin.core.api.SystemStatus;
import de.noctivag.plugin.features.weapons.types.LegendaryWeaponType;
import de.noctivag.plugin.features.weapons.stats.WeaponStatsCalculator;
import de.noctivag.plugin.features.weapons.abilities.WeaponAbilityManager;
import de.noctivag.plugin.features.weapons.abilities.WeaponUpgradeManager;
import de.noctivag.plugin.features.weapons.types.PlayerWeapons;
import de.noctivag.plugin.features.weapons.types.LegendaryWeapon;
import de.noctivag.plugin.features.weapons.types.WeaponStats;
