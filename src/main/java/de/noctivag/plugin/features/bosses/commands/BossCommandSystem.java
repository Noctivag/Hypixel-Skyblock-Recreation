package de.noctivag.plugin.features.bosses.commands;
...
public class BossCommandSystem implements CommandExecutor, TabCompleter {
    ...
    public BossCommandSystem(Plugin plugin, CompleteBossSystem bossSystem, BossMechanicsSystem mechanicsSystem) {
        this.plugin = plugin;
