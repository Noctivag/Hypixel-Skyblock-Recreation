package de.noctivag.plugin.features.menu.integration;
import org.bukkit.inventory.ItemStack;

import de.noctivag.plugin.features.menu.SkyblockMenuSystem;
import de.noctivag.plugin.features.menu.types.MenuType;

import de.noctivag.plugin.features.dungeons.DungeonSystem;
import de.noctivag.plugin.features.minions.AdvancedMinionSystem;
import de.noctivag.plugin.features.collections.AdvancedCollectionsSystem;
import de.noctivag.plugin.features.skills.AdvancedSkillsSystem;
import de.noctivag.plugin.features.armor.DragonArmorSystem;
import de.noctivag.plugin.features.weapons.LegendaryWeaponsSystem;
import de.noctivag.plugin.features.pets.AdvancedPetsSystem;
import de.noctivag.plugin.features.events.AdvancedEventsSystem;
import de.noctivag.plugin.features.economy.AdvancedEconomySystem;
import de.noctivag.plugin.features.cosmetics.AdvancedCosmeticsSystem;
import de.noctivag.plugin.features.stats.CompleteStatsSystem;
import de.noctivag.plugin.features.weapons.CompleteWeaponsSystem;
import de.noctivag.plugin.features.armor.CompleteArmorSystem;
import de.noctivag.plugin.features.tools.CompleteToolsSystem;
import de.noctivag.plugin.features.enchantments.CompleteEnchantmentsSystem;
...
public class HypixelSkyblockIntegration {
    ...
    public HypixelSkyblockIntegration(Plugin plugin, SkyblockMenuSystem menuSystem) {
        this.plugin = plugin;
