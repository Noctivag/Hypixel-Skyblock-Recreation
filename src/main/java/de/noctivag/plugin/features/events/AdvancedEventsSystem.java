...
import de.noctivag.plugin.features.events.types.EventType;
import de.noctivag.plugin.features.events.types.PlayerEventParticipation;
import de.noctivag.plugin.features.events.types.EventInstance;
import de.noctivag.plugin.features.events.types.EventCategory;
import de.noctivag.plugin.features.events.types.EventRarity;
