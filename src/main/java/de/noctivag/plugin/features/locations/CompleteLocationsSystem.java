package de.noctivag.plugin.features.locations;
import org.bukkit.inventory.ItemStack;

import de.noctivag.plugin.Plugin;
import de.noctivag.plugin.core.api.System;
import de.noctivag.plugin.core.api.SystemStatus;
import de.noctivag.plugin.features.locations.types.CompleteLocationType;
import de.noctivag.plugin.features.locations.types.LocationCategory;
import de.noctivag.plugin.features.locations.types.LocationRarity;
import de.noctivag.plugin.features.locations.world.LocationWorldManager;
import de.noctivag.plugin.features.locations.world.LocationAreaMapping;
...
public class CompleteLocationsSystem implements System {
    ...
    public CompleteLocationsSystem(Plugin plugin) {
        this.plugin = plugin;
