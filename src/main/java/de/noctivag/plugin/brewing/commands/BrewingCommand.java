package de.noctivag.plugin.brewing.commands;
import org.bukkit.inventory.ItemStack;

import de.noctivag.plugin.Plugin;
import de.noctivag.plugin.brewing.AdvancedBrewingSystem;
import de.noctivag.plugin.brewing.gui.BrewingGUI;
...
public class BrewingCommand implements CommandExecutor, TabCompleter {
    ...
    public BrewingCommand(Plugin plugin, AdvancedBrewingSystem brewingSystem) {
        this.plugin = plugin;
