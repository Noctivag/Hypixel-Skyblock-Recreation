package de.noctivag.plugin.core.lifecycle;
...
import de.noctivag.plugin.core.di.ServiceLocator;
...
public class PluginLifecycleManager {
    ...
    public PluginLifecycleManager(JavaPlugin plugin, ServiceLocator serviceLocator) {
        this.plugin = plugin;
