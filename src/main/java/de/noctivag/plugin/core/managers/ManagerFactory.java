...
import de.noctivag.plugin.core.managers.impl.UnifiedManagerImpl;
...
public class ManagerFactory {
    ...
    private ManagerFactory(JavaPlugin plugin) {
        this.plugin = plugin;
     ...
     */
    public static synchronized ManagerFactory getInstance(JavaPlugin plugin) {
        if (instance == null) {
