...
import de.noctivag.plugin.gui.MissingItemsGUI;
import de.noctivag.plugin.items.MissingItemsSystem;
import de.noctivag.plugin.items.MissingItemsSystem.ItemCategory;
import de.noctivag.plugin.items.MissingItemsSystem.MissingItem;
...
public class MissingItemsCommand implements CommandExecutor, TabCompleter {
    ...
    public MissingItemsCommand(Plugin plugin) {
