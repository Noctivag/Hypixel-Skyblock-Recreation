...
import de.noctivag.plugin.worlds.generators.CustomWorldGenerator;
import de.noctivag.plugin.network.ExtendedServerTypes;
...
public class AdvancedWorldCommands implements CommandExecutor, TabCompleter {
    ...
    public AdvancedWorldCommands(Plugin plugin, ThreadSafeWorldManager worldManager) {
        this.plugin = plugin;
