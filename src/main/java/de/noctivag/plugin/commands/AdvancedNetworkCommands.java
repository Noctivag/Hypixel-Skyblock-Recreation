...
import de.noctivag.plugin.network.AdvancedNetworkManager;
import de.noctivag.plugin.network.NetworkArchitecture;
...
public class AdvancedNetworkCommands implements CommandExecutor, TabCompleter {
    ...
    public AdvancedNetworkCommands(Plugin plugin, AdvancedNetworkManager networkManager) {
        this.plugin = plugin;
