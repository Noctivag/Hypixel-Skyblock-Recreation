...
public class AdvancedCommandSystem implements CommandExecutor, TabCompleter {
    ...
    public AdvancedCommandSystem(Plugin plugin, MultiServerDatabaseManager databaseManager) {
        this.plugin = plugin;
    ...
    private void showHelp(Player player, String[] args) {
        player.sendMessage("§a§l=== Basics Plugin Help ===");
    ...
    private void showInfo(Player player, String[] args) {
        player.sendMessage("§a§l=== Basics Plugin Info ===");
